<h2><a href="https://leetcode.com/problems/paint-house/?envType=study-plan-v2&envId=dynamic-programming">256. Paint House</a></h2><h3>Medium</h3><hr><p>There is a row of <code>n</code> houses, where each house can be painted one of three colors: red, blue, or green. The cost of painting each house with a certain color is different. You have to paint all the houses such that no two adjacent houses have the same color.</p>
