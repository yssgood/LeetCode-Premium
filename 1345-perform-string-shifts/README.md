<h2><a href="https://leetcode.com/problems/perform-string-shifts">1345. Perform String Shifts</a></h2><h3>Easy</h3><hr><p>You are given a string <code>s</code> containing lowercase English letters, and a matrix <code>shift</code>, where <code>shift[i] = [direction<sub>i</sub>, amount<sub>i</sub>]</code>:</p>
