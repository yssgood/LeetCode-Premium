<h2><a href="https://leetcode.com/problems/remove-interval/?envType=study-plan-v2&envId=premium-algo-100">1272. Remove Interval</a></h2><h3>Medium</h3><hr><p>A set of real numbers can be represented as the union of several disjoint intervals, where each interval is in the form <code>[a, b)</code>. A real number <code>x</code> is in the set if one of its intervals <code>[a, b)</code> contains <code>x</code> (i.e. <code>a &lt;= x &lt; b</code>).</p>
